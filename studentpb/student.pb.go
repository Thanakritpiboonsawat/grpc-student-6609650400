...
func (x *StudentListResponse) GetStudents() []*StudentResponse {
	if x != nil {
		return x.Students
	}
	return nil
...
const file_proto_student_proto_rawDesc = "" +
	...
	"\x05Empty\"K\n" +
	"\x13StudentListResponse\x124\n" +
	"\bstudents\x18\x01 \x03(\v2\x18.student.StudentResponseR\bstudents2\x8f\x01\n" +
...
var file_proto_student_proto_depIdxs = []int32{
	1, // 0: student.StudentListResponse.students:type_name -> student.StudentResponse
